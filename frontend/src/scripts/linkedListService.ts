...
export const fetchGraphviz = async () => {
  try {
    const response = await fetch(`${API_BASE_URL}/linkedList/updateGraph`);
...
export const insertHead = async (value: number) => {
  try {
    await fetch(`${API_BASE_URL}/linkedList/insertHead`, {
      method: 'POST',
      headers: {
...
export const deleteHead = async () => {
  try {
    await fetch(`${API_BASE_URL}/linkedList/deleteHead`, {
      method: 'DELETE',
    });
  } catch (error) {
...
export const insertEnd = async (value: number) => {
  try {
    await fetch(`${API_BASE_URL}/linkedList/insertEnd`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
...
export const deleteEnd = async () => {
  try {
    await fetch(`${API_BASE_URL}/linkedList/deleteEnd`, {
      method: 'DELETE',
    });
  } catch (error) {
...
export const insertAtIndex = async (value: number, index: number) => {
  try {
    await fetch(`${API_BASE_URL}/linkedList/insertAtIndex`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
...
export const deleteAtIndex = async (index: number) => {
  try {
    await fetch(`${API_BASE_URL}/linkedList/deleteAtIndex`, {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json',
      },
